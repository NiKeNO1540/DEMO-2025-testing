...
> **Примечание по безопасности:** Данная настройка разрешает root-доступ по SSH только в целях автоматизации тестового стенда. В рабочей среде такая практика не рекомендуется.
...
Если автоматический скрипт недоступен, выполните настройку вручную согласно [разделу](https://github.com/NiKeNO1540/DEMO-2025-testing/blob/main/1_clear_module_2.md).
